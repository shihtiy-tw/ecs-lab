...
resource "aws_iam_role" "ecs_tasks_execution_role" {
  name               = "${data.aws_ecs_cluster.cluster.cluster_name}-ecs-task-execution-role${var.scenario_name}"
...
resource "aws_iam_role" "ecs_tasks_role" {
  name               = "${data.aws_ecs_cluster.cluster.cluster_name}-ecs-task-role-for-exec-${var.scenario_name}"
